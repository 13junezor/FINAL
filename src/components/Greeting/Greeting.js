...
const Greeting = () => {
    ...
    return (
        ...
        <p className={style.greeding__text}>Обращаем ваше внимание на то, что данный сайт является прототипом, выполненного командой №2 в рамках учебного курса по веб-разработке от СберУниверситета в 2022г.</p>
